...
CORR.FILE <- "combined_mompup.final.8wk.pearson.corr.axes" #Cols: OTU, axis1, p-value, axis2, p-value, length
PCOA.FILE <- "combined_mompup.final.8wk.thetayc.0.03.lt.pcoa.axes" #Cols: group, axis1, axis2, etc.
DESIGN.FILE <- "combined_8WK.design.txt" #Cols: Sample, Group
TIMEPOINT.FILE <- "combined_mompup.final.8wk.shared" #Cols: Otu0001, Otu0002, etc.
TITLE <- "8WK PCoA"
###################################################################

setwd("~/Downloads/Microbiome-2019-07/Cohort_7_9_Mom_Pup/8WK_PCoA/")
...
shape <- data.frame(c(rep(1, 10), rep(16, 11)))  #controls as open, and mets as filled
