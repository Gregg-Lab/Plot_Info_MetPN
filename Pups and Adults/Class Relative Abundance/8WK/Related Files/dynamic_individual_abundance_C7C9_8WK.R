...
setwd("~/Downloads/Microbiome-2019-07/Cohort_7_9_Mom_Pup/8WK_IndividualClassAbundance/") #mac users
...
plots <- ggplot(data=selected_taxa_full, 
  ...
  geom_boxplot() +
  #facet_wrap(~taxa) +
  labs(title = "8wk c_Bacilli Relative Abundance Plot", y = "Relative Abundances (%)", x = "Groups") + 
