...
######ENTER IN VALUES######
TITLE <- "P11 Alpha Diversity"
SUMMARY.FILE <- "combined_mompup.final.0.03.pick.groups.summary" #Cols: [standard raw Mothur file]
DESIGN.FILE <- "combined_P19.design.txt" #Cols: Sample, Group
###########################

setwd("~/Downloads/Microbiome-2019-07/Cohort_7_9_Mom_Pup/P19_AlphaDiversity/")
