...
setwd("~/Downloads/Microbiome-2019-07/Cohort_7_9_Mom_Pup/P19_IndividualGenusAbundance/") #mac users
...
plots <- ggplot(data=selected_taxa_full, 
  ...
  geom_point() +
  #facet_wrap(~taxa) +
  labs(title = "P19 g_ClostridiumXlVa Relative Abundance Plot", y = "Relative Abundances (%)", x = "Groups") + 
