...
TAXONOMY.FILE <- "combined_mompup.final.0.03.cons.taxonomy"
TIMEPOINT.FILE <- "combined_mompup.final.shared"
...
setwd("~/Downloads/Microbiome-2019-07/Cohort_7_9_Mom_Pup/P11_StackedPhylaAbundance/") #mac users
