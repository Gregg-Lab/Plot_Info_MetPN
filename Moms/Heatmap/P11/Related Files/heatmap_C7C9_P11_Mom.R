...
TITLE <- "Dam P11 Heatmap"
##########################################################################

#set working directory to where your .shared file is and load file
setwd("~/Downloads/Microbiome-2019-07/Cohort_7_9_Mom_Pup/P11_Heatmap/")
...
###############################################################
otu.info.lda <- subset(otu.info.raw, select = c(Otu0002, Otu0010, Otu0037, Otu0038, Otu0201, Otu0101, Otu0181, Otu0460, Otu0325, Otu0368)) 
###############################################################
