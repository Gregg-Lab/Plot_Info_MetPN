...
CORR.FILE <- "combined_mompup.final.p11.pearson.corr.axes" #Cols: OTU, axis1, p-value, axis2, p-value, length
PCOA.FILE <- "combined_mompup.final.p11.thetayc.0.03.lt.pcoa.axes" #Cols: group, axis1, axis2, etc.
...
setwd("~/Downloads/Microbiome-2019-07/Cohort_7_9_Mom_Pup/P11_PCoA/")
...
shape <- data.frame(c(rep(1, 6), rep(16, 4)))  #controls as open, and mets as filled
